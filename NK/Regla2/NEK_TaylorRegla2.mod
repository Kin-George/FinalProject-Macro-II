<<<<<<< HEAD
///////////////////////////////////////////////////////////////////////////
//Authores: Sebastián solano S. Jorge Orozco, Rodrigo Jiménez A., Felipe Prado C.
//////////////////////////////////////////////////////////////////////////
/*
Replicamos el código Galí, J. (2015). Se Evaluan 2 escenarios de reglas
de política monetaria y el efecto que genera sobre el bienestar promedio con
choques de productividad y de preferencias.

Fuente del código: 
Johannes Pfeifer y Dmitry Matveev. Copyright (C) 2016-2022 Dmitry Matveev and Johannes Pfeifer
Disponible en: https://github.com/JohannesPfeifer/DSGE_mod/blob/master/Gali_2015/Gali_2015_chapter_4.mod
*/
...
//Brecha del producto respecto a EE
...
@#define simulboth = 1 //Simulaciones con ambos choques
...
fig_histo1= figure;
histogram(L_valuest);
title('L bajo choques tecnológicos(Taylor rule sin expectativas)');
xlabel('L');
ylabel('Frequencia');
exportgraphics(fig_histo1, 'histo21.png', 'Resolution', 300);
@# endif
...
fig_histo2= figure;
histogram(L_valuesd);
title('L bajo choques de preferencias (Taylor rule sin expectativas)');
xlabel('L');
ylabel('Frequencia');
exportgraphics(fig_histo2, 'histo22.png', 'Resolution', 300);
@# endif 
...
fig_histo3= figure;
histogram(L_valuesb);
title('L bajo choques simultáneos (Taylor rule sin expectativas)');
xlabel('L');
ylabel('Frequencia');
% Guardar la figura en un archivo PNG
exportgraphics(fig_histo3, 'hist23.png', 'Resolution', 300);

% Verificar que el archivo se ha guardado
disp('El archivo hist3.png se ha guardado en el directorio de trabajo actual.');
dir('hist23.png')
@# endif

///////////////////////////////////////////////////////////////////////////
//replicando la réplica de la tabla 4.1
@#if nonsimul == 1
...
// Loop incluyendo combinación de parámetros
...
// Bucle considerando los parámetros
for j = 1:length(phis_pi)
    set_param_value('phi_pi', phis_pi(j));
    set_param_value('phi_y', phis_y(j));
    stoch_simul(order=1, irf=0, noprint);
...
>>>>>>> 1a51cdad47817affa9c3f594faf0671cdf1944b7
@# endif